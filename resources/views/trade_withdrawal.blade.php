                                                                                ...
                                                                                <div class="p-1 my-1">
                                                                                    <span class="row">
                                                                                        <span class="mt-1 col-6">
                                                                                            <span
                                                                                                class="pb-0 mb-0 h5 d-block f-w-500 f-14">
                                                                                        ...
                                                                                        <span
                                                                                            class="pb-0 mb-0 col-6 text-end pe-3">
                                                                                            <span
                                                                                                class="mb-0 h5 d-block f-w-500">
                                                        ...
                                                        <div class="row g-1">
                                                            @if ($walletenabled)
                                                                <div class="col-6 col-lg-6 col-xl-6">
                                                                    <div
                                                                        class="border rounded address-check trade-withdraw-type">
