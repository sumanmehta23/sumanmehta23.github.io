                                                    ...
                                                    {{-- {{ dd($acc) }} --}}
                                                        <div class="col-lg-6 col-xl-4 mb-2">
                                                            <div class="auth-option">
                                                                ...
                                                                <label class="auth-megaoption @if(\Carbon\Carbon::parse($acc->competition_start_date)->gte(now('UTC'))) opacity-50 @endif" for="option{{ $acc->ac_index }}" style="height: 230px !important;">
