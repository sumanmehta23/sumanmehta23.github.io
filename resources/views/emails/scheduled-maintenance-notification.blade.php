    ...
    <style>
        * { box-sizing: border-box; }
        ...
        @media (min-width: 621px) {
            .email-main-image { width: 40% !important; margin: 0 auto; }
        }
        @media (max-width: 620px) {
            .email-main-image { width: 100% !important; }
        }
    </style>
        ...
        <tbody>
            ...
            <tr>
                <td>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="padding-bottom:15px;padding-top:15px;width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" class="alignment" style="line-height:10px">
                                                                    <div style="max-width: 300px;"><a href="https://www.lqhmarkets.com/" style="outline:none" tabindex="-1" target="_blank"><img alt="LQH Markets" height="auto" src="{{ url('assets/images/lqh.png') }}" style="display: block; height: auto; border: 0; width: 100%;" title="" width="300" /></a></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <!-- Alert Row -->
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-6" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff5f0;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff5f0; border-radius: 0; color: #000000; width: 600px; margin: 0 auto;" width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top;" width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0" class="paragraph_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="paragraph_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                                        <tr>
                                                            <td class="pad" style="padding-bottom:15px;padding-left:25px;padding-right:25px;padding-top:10px;">
                                                                <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:justify;mso-line-height-alt:18px;">
                                                                    <p style="margin: 0; margin-bottom: 16px;">Best regards,<br /><strong style="color: #00b98e;">LQH Markets Support Team</strong></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-10" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0a1728;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0a1728; border-radius: 0; color: #ffffff; width: 600px; margin: 0 auto;" width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: center; vertical-align: top; padding: 20px;" width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0" class="paragraph_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#ffffff;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:12px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:14px;">
                                                                    <p style="margin: 0; margin-bottom: 8px;">All official communication from <span style="color: #00b98e;"><strong>LQH Markets</strong></span> will be conducted solely through our official email addresses.</p>
                                                                    <p style="margin: 0;">© {{ date('Y') }} LQH Integrated LTD. All rights reserved.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
