...
@section('content')
    ...
    <div class="main-content app-content">
        ...
        : ($user->status == 1
            ...
            : '') !!}@if($kyc_log && isset($kyc_log->callback_payload['applicantId']))<a class="mb-1 fs-12"
                id="sumsub-info"
            href="https://cockpit.sumsub.com/checkus/#/applicant/{{$kyc_log->callback_payload['applicantId']}}/basicInfo?clientId={{config('services.sumsub.clientId')}}">{{$kyc_log->callback_payload['applicantId']}}</a>@endif</span>
                                                        |
                                                        <span
                                ...
                                <div class="border-0 tab-menu-heading">
                                    <div class="tabs-menu1">
                                        <ul class="nav clienttabs">
                                            ...
                                            <li><a href="#tab-transactions" data-bs-toggle="tab" class="">TRANSACTIONS</a>
                                            </li>
                                            ...
                                            <li><a href="#tab-info" data-bs-toggle="tab" class="">ADDITIONAL
                                                    INFO</a></li>
                                            <li><a href="#tab-profile" data-bs-toggle="tab" class="">PROFILE SETTINGS</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-12 col-xl-3">
                                                <div>
                                                                                                                ...
                                                                                                                <div class="card-body d-flex">
                                                                                                                    ...
                                                                                                                    @else
                                                                                                                        <div class="statusToggle"
                                                                                                                            ...
                                                                                                                            <div class="badge text-success"
                                                                                                                                data-bs-toggle="tooltip" title="Email Verified">
                                                                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                                                    width="25" height="25" viewBox="0 0 24 24"
                                                                                                                                    fill="none" stroke="#81C784"
                                                                                                                                    stroke-width="1.5" stroke-linecap="round"
                                                                                                                                    stroke-linejoin="round" size="25"
                                                                                                                                    color="#81C784"
                                                                                                                    ...
                                                                                                                    @can('client:impersonate')
                                                                                                                        <div class="switchClient" data-enc="{{ $user->id }}">
                                                                                                                            <div class="badge text-secondary"
                                                                                                                                data-bs-toggle="tooltip" title="Switch Client">
                                                                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                                        ...
                                                                                                                        <div class="modal-content">
                                                                                                                            <form action="#" id="statusUpdateForm"
                                                                                                                                ...
                                                                                                                                <div class="modal-footer">
                                                                                                                                    ...
                                                                                                                                    <button type="submit" name="ibRequest"
                                                                                                                                        value="update"
                                                    ...
                                                    <div class="card custom-card">
                                                        ...
                                                        <div class="card-body">
                                                            <p class="card-text">A request on behalf of client for creating IB profile for this client.</p>
                                                ...
                                                <div class="card">
                                                    <div class="p-3 card-body">
                                                        <ul class="nav nav-pills nav-tabs nav-justified" role="tablist">
                                                            <?php    for ($i = 1; $i <= 15; $i++) { ?>
                                                            <li class="nav-item" data-target-form="#LEVEL{{ $i }}"
                                                                role="presentation"><a
                                                                    class="nav-link client-level {{ $i == 1 ? 'active' : '' }}"
                                                                    data-level="{{ $i }}" aria-selected="false" role="tab"
                                                                    tabindex="-1"><i class="ti ti-chart-bar me-2"></i><span
