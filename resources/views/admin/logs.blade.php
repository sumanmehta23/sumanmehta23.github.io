                                    ...
                                    @php
                                        ...
                                        switch ($log->properties['remark'] ?? '') {
                                            ...
                                            case 'Ib Request':
                                                ...
                                                $planName = $ib_plan && $ib_plan->plan ? $ib_plan->plan->ib_cat_name : '';
                                                if ($ib_status==1) {
                                                    $logDescription = "<div class=''>
                                                                    <span style=''>User {$userLink} approve ib request of client {$client_url} having plan {$planName}.</span>
                                                                </div>";
                                                }elseif($ib_status==0){
                                                    $logDescription = "<div class=''>
                                                                    <span style=''>User {$userLink} change ib request of client {$client_url} having plan {$planName} to pending.</span>
                                                                </div>";
                                                }elseif($ib_status==2){
                                                    $logDescription = "<div class=''>
                                                                    <span style=''>User {$userLink} change ib request of client {$client_url} having plan {$planName} to rejected.</span>
                                                                </div>";
                                                }
