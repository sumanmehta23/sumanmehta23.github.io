...
@section('styles')
    <style>
        @media (max-width: 767.98px) {
            ...
            .live-mobile-card__icon img {
                width: 2rem;
                height: 2rem;
                object-fit: contain;
            }

            .live-mobile-card__title {
                margin: 0;
                font-size: 1.55rem;
                font-weight: 700;
                line-height: 1.1;
            ...
            .live-mobile-card__content {
                min-width: 0;
            }

            .live-mobile-card__badge {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                margin-top: 0.45rem;
            ...
            .live-mobile-card__leverage-wrap {
                min-width: fit-content;
                text-align: right;
            }

            .live-mobile-card__leverage-label {
                display: block;
            ...
            .live-mobile-card__leverage-value {
                display: block;
                margin-top: 0.2rem;
                color: #0d6f66;
                font-size: 1.7rem;
            ...
            .live-mobile-card__meta-label {
                color: rgba(22, 52, 50, 0.68);
                font-size: 0.92rem;
                font-weight: 500;
            }

            .live-mobile-card__meta-value {
                color: #163432;
                font-size: 0.95rem;
                font-weight: 600;
                text-align: right;
            ...
            .live-mobile-card__stats {
                display: grid;
                grid-template-columns: repeat(2, minmax(0, 1fr));
                gap: 0.75rem;
            }

            .live-mobile-card__stat {
            ...
            .live-mobile-card__actions {
                display: grid;
                gap: 0.75rem;
                margin-top: 1rem;
            }

            .live-mobile-card__btn {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-height: 3.2rem;
            ...
            .live-mobile-card__notice--danger {
                background: rgba(220, 53, 69, 0.08);
                border: 1px solid rgba(220, 53, 69, 0.16);
                color: #b42318;
            }

            .live-mobile-card__notice--warning {
                                        ...
                                        <div class="mb-3 live-mobile-card">
                                            <div class="live-mobile-card__head">
                                                <div class="live-mobile-card__identity">
                                                    <div class="live-mobile-card__icon">
                                                        <img src="/assets/images/mt5.png" alt="Account icon">
                                                    </div>
                                                    <div class="live-mobile-card__content">
                                                        @if ($acc->code && $acc->code != 'Rejected')
                                                            <h5 class="live-mobile-card__title">{{ $acc->code }}</h5>
                                                        ...
                                                        @endif
                                                        <span class="live-mobile-card__badge">{{ $acc->accountType->ac_name }}</span>
                                                    </div>
                                                </div>

                                                <div class="live-mobile-card__leverage-wrap">
                                                    <span class="live-mobile-card__leverage-label">Leverage</span>
                                                    <strong class="live-mobile-card__leverage-value">1:{{ $acc->leverage }}</strong>
                                                </div>
                                            </div>
                                            ...
                                            <div class="live-mobile-card__stats">
                                                <div class="live-mobile-card__stat">
                                                    ...
                                                    <p class="live-mobile-card__stat-value">$ {{ number_format((float) $acc->balance, 2) }}</p>
                                                </div>
                                                <div class="live-mobile-card__stat">
                                                    <span class="live-mobile-card__stat-label">Equity</span>
                                                    <p class="live-mobile-card__stat-value">$ {{ number_format((float) $acc->equity, 2) }}</p>
                                                </div>
                                            </div>

                                            @if ($acc->code && $acc->code != 'Rejected')
                                                <div class="live-mobile-card__actions"
                                                    style="grid-template-columns: repeat({{ $acc->isZapierAccount() ? 2 : 3 }}, minmax(0, 1fr));">
                                                    <a href="{{ route('view-account-details', $acc->id) }}"
                                                        class="live-mobile-card__btn">
                                                        View
                                                    </a>
                                                    @if (!$acc->isZapierAccount())
                                                        <a href="{{ url('/trade-deposit') }}" class="live-mobile-card__btn live-mobile-card__btn--primary">
                                                            Deposit
                                                        </a>
                                                    @endif
