(function () {
  ...
  function toggleTheme() {
    ...
    if (html.getAttribute("data-theme-mode") === "dark") {
      ...
      localStorage.removeItem("VolghMenu");
      localStorage.removeItem("VolghHeader");
      ...
      localStorage.setItem("VolghMenu", "dark");
      localStorage.setItem("VolghHeader", "dark");
      localStorage.removeItem("bodylightRGB");
      localStorage.removeItem("bodyBgRGB");
    }
  }
  ...
  var myHeaderMessage = document.getElementById("messages-dropdown-scroll");
