...
return new class extends Migration
{
    ...
    {
        Schema::create('metatradertradehistory', function (Blueprint $table) {
            ...
            $table->integer('version')->default(5);
            ...
            $table->double('lotConversion', null, 0)->default(0);
            $table->boolean('showRow')->default(true);
    ...
    {
        Schema::dropIfExists('metatradertradehistory');
    }
};
