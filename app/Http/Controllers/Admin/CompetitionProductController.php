...
class CompetitionProductController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.competitions.index', compact('mt5_groups', 'activeType', 'activeGroup', 'competition_group'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.competitions.index')->with('success', 'Group Created Successfully');
    }
