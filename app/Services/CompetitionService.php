...
class CompetitionService
{
    ...
    {
        return Account::with(['user', 'accountType', 'tradeDeposits' => function($query) use ($month, $year) {
            ...
            ->map(function($account, $index) {
                return [
                    ...
                    'total_trades' => $account->tradeDeposits->count(),
                    'total_profit' => $account->tradeDeposits->sum('profit')
                ];
            });
    }
